        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <div class="flex items-start space-x-6">
                                ...
                                <!-- Contact Info -->
                                <div class="flex-1">
                                    <h1 class="text-2xl font-bold text-gray-900 mb-2">{{ $contact->name }}</h1>
                                    ...
                                    <div class="space-y-3">
                                        ...
                                        <div class="flex items-center text-gray-600">
                                            ...
                                            <a href="tel:{{ $contact->phone }}" class="hover:text-indigo-600">
                                                {{ $contact->phone }}
                                            </a>
                                        </div>
                                        ...
                                        <div class="flex items-center text-gray-600">
                                            ...
                                            <span>Added {{ optional($contact->created_at)->format('M d, Y') ?? 'Recently' }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    @if($contact->description)
                        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                            <div class="p-6">
                                ...
                                <p class="text-gray-600 leading-relaxed">{{ $contact->description }}</p>
                            </div>
                        </div>
                    @endif
                            ...
                            <dl class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900">
                                        {{ optional($contact->updated_at)->format('M d, Y \a\t g:i A') ?? 'Never' }}
                                    </dd>
                                </div>
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6">
                            <h3 class="text-lg font-semibold text-gray-900 mb-4">Export Contact</h3>
                            <div class="space-y-3">
                                ...
                                <button onclick="window.print()"
                                        class="w-full inline-flex items-center justify-center px-4 py-2 bg-gray-100 border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition ease-in-out duration-150">
                                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
END:VCARD`;
            ...
            a.href = url;
            a.download = '{{ Str::slug($contact->name) }}.vcf';

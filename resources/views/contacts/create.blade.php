        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="bg-gradient-to-r from-indigo-500 to-purple-600 px-6 py-4">
                    ...
                    <p class="text-indigo-100 text-sm mt-1">Fill in the information below to create a new contact</p>
                </div>

                <!-- Form Body -->
                <div class="p-6">
                    <form method="POST" enctype="multipart/form-data" action="{{ route('contacts.store') }}" class="space-y-6">
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            ...
                            Image attachments must be less than 2MB in size.
                        </p>
                    </div>
                </div>
            </div>
